package ch.bbcag.backend.ticketshop.entitytests;
...
class EventTest {
    ...
    public void constructor_hasEmptyConstructor() {
        Class<?> eventClass = ch.bbcag.backend.ticketshop.event.Event.class;
    ...
    public void class_isAnnotatedWithEntity() {
        assertNotNull(ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredAnnotation(Entity.class));
    }

    @Test
    @Order(2)
    public void idField_doesExist() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredField("id"));
    }
    ...
    public void idField_isAnnotatedWithId() {
        try {
            assertNotNull(ch.bbcag.backend.ticketshop.event.Event.class
                    .getDeclaredField("id")
    ...
    public void idFieldGeneratedValueAnnotation_isStrategyIdentity() {
        try {
            assertEquals(GenerationType.IDENTITY, ch.bbcag.backend.ticketshop.event.Event.class
                    .getDeclaredField("id")
                    .getDeclaredAnnotation(GeneratedValue.class)
                    .strategy()
            );
    ...
    public void nameField_doesExist() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredField("name"));
    }

    @Test
    @Order(4)
    public void ownerField_doesExist() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredField("owner"));
    }
    ...
    public void ownerFieldJoinColumnAnnotation_isNameOwnerId() {
        try {
            assertEquals("owner_id", ch.bbcag.backend.ticketshop.event.Event.class
                    .getDeclaredField("owner")
                    .getDeclaredAnnotation(JoinColumn.class)
                    .name()
            );
    ...
    public void ticketsField_doesExist() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredField("tickets"));
    }
    ...
    public void ticketsFieldOneToManyAnnotation_isMappedByEvent() {
        try {
            assertEquals("event", ch.bbcag.backend.ticketshop.event.Event.class
                    .getDeclaredField("tickets")
                    .getDeclaredAnnotation(OneToMany.class)
                    .mappedBy()
            );
    ...
    public void dateField_doesExist() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredField("date"));
    }

    @Test
    @Order(7)
    public void descriptionField_doesExist() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredField("description"));
    }

    @Test
    @Order(8)
    public void equalsMethod_isDeclared() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredMethod("equals", Object.class));
    }

    @Test
    @Order(8)
    public void equalsMethod_comparesOnlyId() {
        ch.bbcag.backend.ticketshop.event.Event event1 = DataUtil.getTestEvent();
        ch.bbcag.backend.ticketshop.event.Event event2 = DataUtil.getTestEvent();
    ...
    public void hashCodeMethod_isDeclared() {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredMethod("hashCode"));
    }
    ...
    public void checkGetter_doExist(String getterName) {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredMethod(getterName));
    }
    ...
    public void checkSetter_doExist(String setterName, String parameterClassName) {
        assertDoesNotThrow(() -> ch.bbcag.backend.ticketshop.event.Event.class.getDeclaredMethod(setterName, Class.forName(parameterClassName)));
    }
}
