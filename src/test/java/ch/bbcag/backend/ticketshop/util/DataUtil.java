...
public class DataUtil {
    ...
    public static List<Person> getTestPersons() {
        ...
        for (int i = 1; i <= 4; i++) {
           ...
           // person.setRoles(new HashSet<>());
            ch.bbcag.backend.ticketshop.event.Event event = new ch.bbcag.backend.ticketshop.event.Event();
    ...
    public static ch.bbcag.backend.ticketshop.event.Event getTestEvent() {
        return getTestEvents().get(0);
    }

    public static List<ch.bbcag.backend.ticketshop.event.Event> getTestEvents() {
        List<ch.bbcag.backend.ticketshop.event.Event> events = new ArrayList<>();
